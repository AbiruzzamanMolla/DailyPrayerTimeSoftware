        ...
        <div className="settings-content">
          {activeTab === "appearance" && (
            <div className="appearance-settings">
              ...
              <div className="setting-group">
                <label>Show Taskbar Overlay</label>
                <div className="toggle-group">
                  <button
                    className={`toggle-btn ${safeSettings.showOverlay ? "active" : ""}`}
                    onClick={() => handleSettingChange("showOverlay", true)}
                  >
                    Enabled
                  </button>
                  <button
                    className={`toggle-btn ${!safeSettings.showOverlay ? "active" : ""}`}
                    onClick={() => handleSettingChange("showOverlay", false)}
                  >
                    Disabled
                  </button>
                </div>
