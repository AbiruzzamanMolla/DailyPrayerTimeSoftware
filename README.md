...
## 🚀 Daily Prayer Timer (Native) - v1.7.6
...
[![Version](https://img.shields.io/badge/version-1.7.6-blue.svg)](https://github.com/AbiruzzamanMolla/DailyPrayerTimeSoftware/releases)
...
| Platform | Installer |
|---|---|
| **Windows 10/11 (64-bit)** | `DailyPrayerTimer_Setup_v1.7.6_x64.exe` |
| **Windows 10/11 (32-bit)** | `DailyPrayerTimer_Setup_v1.7.6_x86.exe` |
